...
Begin VB.Form frmStaffMgt1 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Staff Management - Senior Staff Personnel"
   ClientHeight    =   6405
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9840
   Icon            =   "frmStaffMgt1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cboSex 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "frmStaffMgt1.frx":030A
         Left            =   1200
         List            =   "frmStaffMgt1.frx":0314
         TabIndex        =   27
         Top             =   960
         Width           =   1095
      End
   ...
   End
End
Attribute VB_Name = "frmStaffMgt1"
...
Private Sub Command1_Click()
    ...
    Else
        ...
        'create SQL stmt
        If checkFields Then
            staffID = InputBox("Please assign to this Staff an ID Number!" & vbCrLf & "Format (SS-2003-001)")
            sSQL = "insert into tblSeniorStaff(tblStaffID, tblSurname, tblFirstName, tblSex, tblAge, tblAddress, tblPhoneNo, tblNextofKin, tblNOKAddress, tblNOKPhone, tblStaffGuarantor, tblStaffGuarantorAddress, tblStaffGuarantorPhone) values ('" & UCase$(staffID) & "','" & txtSurname & "','" & txtFirstName & "','" & cboSex & "'," & txtAge & ",'" & Me.txtAddress & "','" & Me.txtPhoneNo & "','" & Me.txtNOK & "','" & Me.txtNOKAddress & "','" & Me.txtNOKPhone & "','" & Me.txtStaffG & "','" & Me.txtStaffGAddress & "','" & Me.txtStaffGPhone & "')"
...
Public Sub LoadStaffID()
    sSQL = "select tblStaffID from tblSeniorStaff"
...
Public Sub Command2_Click()
    ...
    Else
        ...
        sSQL = "update tblSeniorStaff set tblSurname = '" & txtSurname & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblFirstName = '" & txtFirstName & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblAge = '" & txtAge & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblAddress = '" & txtAddress & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblPhoneNo = '" & txtPhoneNo & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblNextofKin = '" & txtNOK & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblNOKAddress = '" & txtNOKAddress & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblNOKPhone = '" & txtNOKPhone & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblStaffGuarantor = '" & txtStaffG & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblStaffGuarantorAddress = '" & txtStaffGAddress & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
        sSQL = "update tblSeniorStaff set tblStaffGuarantorPhone = '" & txtStaffGPhone & "' where tblSTaffId = '" & List1.Text & "'"
        cn.Execute sSQL
...
Private Sub Command4_Click()
    If List1.ListIndex <> -1 Then
        sSQL = "insert into tblSuspend1(tblStaffID, tblSurname, tblFirstName, tblSex, tblAge, tblAddress, tblPhoneNo, tblNextofKin, tblNOKAddress, tblNOKPhone, tblStaffGuarantor, tblStaffGuarantorAddress, tblStaffGuarantorPhone) values ('" & List1.Text & "','" & txtSurname & "','" & txtFirstName & "','" & cboSex & "'," & txtAge & ",'" & Me.txtAddress & "','" & Me.txtPhoneNo & "','" & Me.txtNOK & "','" & Me.txtNOKAddress & "','" & Me.txtNOKPhone & "','" & Me.txtStaffG & "','" & Me.txtStaffGAddress & "','" & Me.txtStaffGPhone & "')"
        cn.Execute sSQL
...
Private Sub List1_Click()
    On Error Resume Next
    sSQL = "select * from tblSeniorStaff where tblstaffid = '" & List1.Text & "'"
    Set rsStaff = cn.Execute(sSQL)
