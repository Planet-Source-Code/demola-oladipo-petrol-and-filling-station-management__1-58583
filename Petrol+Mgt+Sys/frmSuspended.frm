...
Begin VB.Form frmSuspended 
   ...
   End
End
Attribute VB_Name = "frmSuspended"
...
Private Sub Command1_Click()
    ...
    sSQL = "select * from tblSuspend where tblStaffID = '" & List1.List(Combo1.ListIndex) & "'"
    ...
    sSQL = "delete from tblSuspend where tblStaffId = '" & List1.List(Combo1.ListIndex) & "'"
    cn.Execute sSQL
...
Sub loadID()
    sSQL = "select tblStaffID, tblSurname, tblFirstname from tblSuspend"
    Set rsStaff = cn.Execute(sSQL)
    Combo1.Clear
    List1.Clear
    With rsStaff
